...
export default function OtpScreen({ route }: OtpScreenProps) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={[styles.subText, styles.elevatedText]}>OTP Verfication</Text>
      </View> 
      <View style={styles.infoContainer}>
      <Text style={styles.infoText}>Enter the 6-digit OTP sent to you Email or Mobile No.</Text>
      </View> 
    ...
    <View style={styles.resendOtpContainer}>
        <Icon name="refresh" style={[styles.icon, {color: timer === 0 ? '#003C43' : isButtonDisabled ? 'grey' : '#003C43' }]}/>
        <TouchableOpacity 
        onPress={handleResendOTP}
        disabled={timer !== 0}
        activeOpacity={isButtonDisabled ? 0.7 : 1}>
             <Text 
             style={[styles.resendOtpText, styles.elevatedText, { color: timer === 0 ? '#003C43' : isButtonDisabled ? 'grey' : '#003C43' }]}
