    ...
    <SafeAreaView style={{flex: 1}}>
      <View style={styles.container}>
        ...
        <View
          style={[
            styles.mainCard,
            isPeakHours ? styles.peakMainCard : styles.elevatedLogo,
          ]}>
          <View style={styles.peakHoursContainer}>
            <Text
              style={[
                styles.elevatedText,
                isPeakHours ? styles.peakHoursTextOn : styles.peakHoursTextOff,
              ]}>
          ...
          <View style={styles.dataCard}>
            <TouchableOpacity>
              <Icon
                style={[
                  styles.elevatedText,
                  isPeakHours ? styles.plugIconPeakhours : styles.plugIcon,
                ]}
                name="plug"
              />
          ...
          <View style={styles.cardTitleContainer}>
            <Text style={styles.dataTitle}>Real-Time Usage</Text>
          </View>
        </View>
              ...
              <View
                ...
                <View style={styles.cardMonthContainer}>
                  <Text style={[styles.monthText, styles.elevatedText]}>
                    {selectedDataType === 'monthly'
                      ...
                      : selectedDataType === 'weekly'
                      ? `Week of ${moment(
                          (data as WeeklyData).weekStart,
                        ).format('YYYY-MM-DD')}`
                      : (data as DailyData).dayOfWeek}
                  </Text>
                  {data.time ? <Text>{String(data.time)}</Text> : null}
                </View>
                ...
                <View style={styles.cardUnitsContainer}>
                  <Text style={[styles.unitsDataText, styles.elevatedText]}>
                    {data.unitsUsed !== undefined
                      ? String(data.unitsUsed.toFixed(1))
                      : 'N/A'}
                  </Text>
        ...
        <View style={styles.bottomButtonContainer}>
          <TouchableOpacity
            onPress={() => navigation.navigate('PredictScreen')}
            activeOpacity={0.8}
            style={[styles.bottomButton, styles.elevatedMidLayer]}>
            <Icon4
              name="graph"
          ...
          <TouchableOpacity
            ...
            <Icon3
              name="time-outline"
              style={[styles.iconPeak, styles.elevatedText]}
            />
